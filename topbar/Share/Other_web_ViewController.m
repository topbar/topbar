...
@interface Other_web_ViewController ()<UIWebViewDelegate,WKNavigationDelegate,WKUIDelegate,UINavigationControllerDelegate>

@end

@implementation Other_web_ViewController
