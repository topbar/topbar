//
//  news_list_h5_A_ViewController.m
//  topbar
//
//  Created by guo feng zou on 2020/3/10.
//  Copyright © 2020 guo feng zou. All rights reserved.
////新闻加载H5页面，采用WKWebView，自定义导航（顶部）

#import "news_list_h5_A_ViewController.h"
#import "MJRefresh.h"
@interface news_list_h5_A_ViewController ()<UIWebViewDelegate,WKNavigationDelegate,WKUIDelegate,UINavigationControllerDelegate>

@end

@implementation news_list_h5_A_ViewController
