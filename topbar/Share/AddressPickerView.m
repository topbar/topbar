...
//  topbar
//
//  Created by guo feng zou on 2019/11/18.
...
- (UIColor *)backMaskColor {
    if (!_backMaskColor) {
       // _backMaskColor = [[UIColor blackColor] colorWithAlphaComponent:0.5];
        _backMaskColor =   [UIColor colorWithRed:0 green:0 blue:0 alpha:0.4];
    }
