...
- (void)jsonParse{
 //    NSLog(@"%@",_type);
 //     NSLog(@"%@",_titlea);
    NSString *api_url = [NSString stringWithFormat:@"public/v1/ticker?start=22&limit=10&convert=cny"];
                                        ...
                                        if (!error )
                                        {
                                           ...
                                           // NSMutableArray * array = [dic objectForKey:@"news"];
                                            ...
                                            //写入沙盒
                                             ...
                                             NSString *documnetPath = [documents stringByAppendingPathComponent:@"feixiaohao_2.plist"];
