//
//  Login_PresentationController.m
//  topbar
//
...
@interface Login_PresentationController () <UIViewControllerAnimatedTransitioning>
/** 黑色半透明背景 */
...
@implementation Login_PresentationController
//| ------------------------------第一步内容----------------------------------------------
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    CGFloat h = screenH - 100.f * 2;
    CGRect topFrame = CGRectMake(x, y, w, h);
    
    // 屏幕中间：
    CGRect centerFrame = CGRectMake(x, 100.0, w, h);
