...
@interface Wallet_ViewController ()

@end

@implementation Wallet_ViewController
...
-(void)Nav_UI
{
    ...
    [DD setImage:[UIImage imageNamed:@"Mesg_w"] forState:UIControlStateNormal];
...
-(void)HeadCon
{
    ...
    Meny.text = [NSString stringWithFormat:@"%.8f",((float)(arc4random()%100000000) / 100000000)+(arc4random()%100)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath//这个是必需的，
{
     ...
     if (indexPath.section == 0)
    {
        if (indexPath.row == 0)
        {
            ...
            [bb setText: [NSString stringWithFormat:@"%.6f",((float)(arc4random()%100000000) / 100000000)+(arc4random()%10000)]];
            ...
            UILabel * ff = [[UILabel alloc]initWithFrame:CGRectMake(ScreenWidth-(ScreenWidth/5), 50, 100, 20)];
            //[ff setText:@"0.00"];
            [ff setText: [NSString stringWithFormat:@"%.2f",((float)(arc4random()%100) / 100)+(arc4random()%100000)]];
        ...
        if (indexPath.row == 1)
        {
            ...
            UILabel * bb = [[UILabel alloc]initWithFrame:CGRectMake(ScreenWidth/20, 50, 100, 20)];
            [bb setText: [NSString stringWithFormat:@"%.8f",((float)(arc4random()%100000000) / 100000000)+(arc4random()%100)]];
            bb.font = [UIFont systemFontOfSize:14];
            bb.textColor = [UIColor blackColor];
            [cell.contentView addSubview:bb];
            ...
            UILabel * dd = [[UILabel alloc]initWithFrame:CGRectMake(ScreenWidth/3, 50, 100, 20)];
            //[dd setText:@"0.00000000"];
            [dd setText: [NSString stringWithFormat:@"%.8f",((float)(arc4random()%100000000) / 100000000)+(arc4random()%100)]];
            dd.font = [UIFont systemFontOfSize:14];
            dd.textColor = [UIColor blackColor];
            [cell.contentView addSubview:dd];
...
-(void)Authentication
{
        ...
        //[PopView coutomshowInView:[UIApplication sharedApplication].keyWindow];
         ...
         __block Wallet_ViewController *blockSelf = self;//创建一个本地变量blockSelf，指向self，然后用结构体语法访问实例变量
