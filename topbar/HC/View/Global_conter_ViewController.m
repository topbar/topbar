//
//  Global_conter_ViewController.m
//  topbar
//
...
@interface Global_conter_ViewController ()
@property (nonatomic,strong)UIButton *spButton;
@end

@implementation Global_conter_ViewController
...
- (void)jsonParse{
 //    NSLog(@"%@",_type);
 //     NSLog(@"%@",_titlea);
    NSString *api_url = [NSString stringWithFormat:@"public/v1/ticker?limit=50&convert=cny"];
