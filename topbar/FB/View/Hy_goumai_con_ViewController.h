//
//  Hy_goumai_con_ViewController.h
//  topbar
//
...
@interface Hy_goumai_con_ViewController : UIViewController<NSURLConnectionDataDelegate,UITableViewDelegate,UITableViewDataSource,NSURLSessionDelegate>
{
