...
@interface Add_order_s_ViewController : UIViewController<UINavigationControllerDelegate,UITableViewDelegate,UITableViewDataSource>
{
...
@property (nonatomic, strong) NSString *black_A;//当多个页页调用时返回不同地方
