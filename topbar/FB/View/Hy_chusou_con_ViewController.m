//
//  Hy_chusou_con_ViewController.m
//  topbar
//
...
@interface Hy_chusou_con_ViewController ()

@end

@implementation Hy_chusou_con_ViewController
...
- (void)jsonParse{
        ...
        NSString * Urladd =[NSString stringWithFormat:@"action=goumai&Pagesums=1&type=1&Currency=%@",_titlea];
        //NSLog(@"cc==%@",Urladd);
...
- (void)jsonParse_more{
    ...
    NSURL *url = [NSURL URLWithString:UserApi];
    NSString * Urladd =[NSString stringWithFormat:@"action=goumai&Pagesums=%ld&type=1&Currency=%@",(long)currentPage,_titlea];
