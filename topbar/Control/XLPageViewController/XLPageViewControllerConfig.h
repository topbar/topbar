...
/**
 分段选择器背景颜色
 */
@property (nonatomic, strong) UIColor *segmentedBgColor;

/**
分段选择器正常字体颜色
*/
@property (nonatomic, strong) UIColor *titleNOcolor;
/**
分段选择器正常字体大小
*/
@property (nonatomic, strong) UIFont *titleNOdFont;
/**
分段选择器选择后字体颜色
*/
@property (nonatomic, strong) UIColor *titleSedcolor;
/**
分段选择器选择后字体大小
*/
@property (nonatomic, strong) UIFont *titleSedFont;
