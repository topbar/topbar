...
+  (XLPageViewControllerConfig *)defaultConfig {
    ...
    /**
     分段选择器背景颜色
     */
    config.segmentedBgColor= [UIColor redColor];

    /**
    分段选择器正常字体颜色
    */
    config.titleNOcolor = [UIColor orangeColor];
    /**
    分段选择器正常字体大小
    */
    ...
    分段选择器选择后字体颜色
    */
    config.titleSedcolor = [UIColor grayColor];;
    /**
    分段选择器选择后字体大小
    */
    config.titleSedFont = [UIFont systemFontOfSize:16];
